...
PreferenceIngredient.destroy_all
...
# Recipe 3
recipe = Recipe.create(name: "Bora Bora",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 6
recipe = Recipe.create(name: "Mountain Bramble",
event_type: ["Home", "Special Ocasion"],
...
# Recipe 7
recipe = Recipe.create(name: "Apple Highball",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 8
recipe = Recipe.create(name: "Snowball",
event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 9
recipe = Recipe.create(name: "Caipirinha",
event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 10
recipe = Recipe.create(name: "Mango Mojito",
              event_type: ["Home", "Business", "Special Ocasion"],
...
ingredients = ["Lime", "Mango", "Mint", "White Rum", "Ice", "Soda Water"]
ingredients.each do |ingredient|
  RecipeIngredient.create(recipe: recipe, ingredient: Ingredient.find_by(name: ingredient.downcase))
end

# Recipe 11
recipe = Recipe.create(name: "Kiwi Martini",
              event_type: ["Home", "Business", "Special Ocasion"],
...
ingredients = ["Kiwi", "Sugar Syrup", "Vodka"]
ingredients.each do |ingredient|
  RecipeIngredient.create(recipe: recipe, ingredient: Ingredient.find_by(name: ingredient.downcase))
end

# Recipe 12
recipe = Recipe.create(name: "Adam Bomb",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 13
recipe = Recipe.create(name: "A Furlong Too Late",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 15
recipe = Recipe.create(name: "Frozen Mint Daiquiri",
              event_type: ["Home", "Business", "Special Ocasion"],
 ...
 # Recipe 16
recipe = Recipe.create(name: "Kiwi Papaya Smoothie",
              event_type: ["Home", "Business", "Special Ocasion"],
              instruction: "Throw everything into a blender and liquify.",
              alcohol: "Non-alcoholic",
              cocktail_category: ["Fruity"],
...
# Recipe 17
recipe = Recipe.create(name: "Apple Berry Smoothie",
              event_type: ["Home", "Business", "Special Ocasion"],
              instruction: "Throw everything into a blender and liquify.",
              alcohol: "Non-alcoholic",
              cocktail_category: ["Fruity"],
              image_url: "https://www.thecocktaildb.com/images/media/drink/xwqvur1468876473.jpg")
              ingredients = ["Apple", "Berries"]
              ingredients.each do |ingredient|
                RecipeIngredient.create(recipe: recipe, ingredient: Ingredient.find_by(name: ingredient.downcase))
              end

# Recipe 18
recipe = Recipe.create(name: "Caipirissima",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 19
recipe = Recipe.create(name: "Blue Margarita",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 20
recipe = Recipe.create(name: "Lassi Khara",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 21
recipe = Recipe.create(name: "Vampiro",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 22
recipe = Recipe.create(name: "Lemouroudji",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 23
recipe = Recipe.create(name: "Apello",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 23
recipe = Recipe.create(name: "Downshift",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 24
recipe = Recipe.create(name: "Fruit Flip-Flop",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 25
recipe = Recipe.create(name: "Bellini Martini",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 28
recipe = Recipe.create(name: "Garibaldi Negroni",
              event_type: ["Home", "Business", "Special Ocasion"],
              ...
              ingredients = ["Gin", "Campari", "Sprite", "Orange juice", "Orange peel"]
              ingredients.each do |ingredient|
                RecipeIngredient.create(recipe: recipe, ingredient: Ingredient.find_by(name: ingredient.downcase))
              end

# Recipe 29
recipe = Recipe.create(name: "Amaretto Sour",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 30
recipe = Recipe.create(name: "Monkey Gland",
              event_type: ["Home", "Special Ocasion"],
              ...
              ingredients = ["Gin", "Orange juice", "Benedictine", "Grenadine"]
              ingredients.each do |ingredient|
                RecipeIngredient.create(recipe: recipe, ingredient: Ingredient.find_by(name: ingredient.downcase))
              end

# Recipe 31
recipe = Recipe.create(name: "Atlantic Sun",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 32
recipe = Recipe.create(name: "Tom Collins",
              event_type: ["Home", "Business", "Special Ocasion"],
              instruction: "Shake all the ingredients, top the drink with soda. Garnish with a slice of orange.",
              alcohol: "Alcoholic",
              cocktail_category: ["Fruity"],
              image_url: "https://www.thecocktaildb.com/images/media/drink/7cll921606854636.jpg")
              ingredients = ["Gin", "Lemon juice", "Sugar", "Maraschino cherry", "Club soda", "Orange"]
              ingredients.each do |ingredient|
                RecipeIngredient.create(recipe: recipe, ingredient: Ingredient.find_by(name: ingredient.downcase))
              end

# Recipe 33
recipe = Recipe.create(name: "Arctic Fish",
              event_type: ["Home", "Special Ocasion"],
              ...
              ingredients = ["Vodka", "Orange juice", "Grape soda", "Ice", "Candy"]
              ingredients.each do |ingredient|
                RecipeIngredient.create(recipe: recipe, ingredient: Ingredient.find_by(name: ingredient.downcase))
              end

# Recipe 34
recipe = Recipe.create(name: "Blue Lagoon",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 35
recipe = Recipe.create(name: "Frozen Pineapple Daiquiri",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 37
recipe = Recipe.create(name: "Cranberry Punch",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 38
recipe = Recipe.create(name: "San Francisco",
              event_type: ["Home", "Business", "Special Ocasion"],
...
recipe = Recipe.create(name: "Lemon Elderflower Spritzer",
              ...
              ingredients = ["Elderflower cordial", "Vodka", "Soda Water", "Fresh Lemon Juice", "Bourbon", "Lemon peel"]
              ingredients.each do |ingredient|
                RecipeIngredient.create(recipe: recipe, ingredient: Ingredient.find_by(name: ingredient.downcase))
              end

# Recipe 41
recipe = Recipe.create(name: "Cuba Libre",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 42
recipe = Recipe.create(name: "Rum Runner",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 43
recipe = Recipe.create(name: "Ipanema",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 44
recipe = Recipe.create(name: "Long Island Iced Tea",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 45
recipe = Recipe.create(name: "Spiced Peach Punch",
              event_type: ["Home", "Business", "Special Ocasion"],
              instruction: "Cut half a lime into pieces, place in a shaker, add the sugar and crush. Measure the passion fruit juice, add it to the shaker and fill up with ice cubes. Close the shaker and shake vigorously. Pour the liquid into a glass, top up with ginger ale, stir with a teaspoon and then garnish the rim of the glass with a slice of lime",
              alcohol: "Non-alcoholic",
              cocktail_category: ["Fruity"],
...
# Recipe 46
recipe = Recipe.create(name: "Brave Bull Shooter",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 47
recipe = Recipe.create(name: "Barracuda",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 48
recipe = Recipe.create(name: "Tequila Sunrise",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 49
recipe = Recipe.create(name: "Banana Strawberry Shake",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 51
recipe = Recipe.create(name: "Chocolate Black Russian",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 52
recipe = Recipe.create(name: "Screaming Orgasm",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 53
recipe = Recipe.create(name: "Almeria",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 54
recipe = Recipe.create(name: "Pysch Vitamin Light",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 55
recipe = Recipe.create(name: "Big Red",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 56
recipe = Recipe.create(name: "Martinez 2",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 57
recipe = Recipe.create(name: "Port Wine Flip",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 58
recipe = Recipe.create(name: "Port Wine Cocktail",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 60
recipe = Recipe.create(name: "Long Island Tea",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 61
recipe = Recipe.create(name: "Blueberry Mojito",
              event_type: ["Home", "Business", "Special Ocasion"],
              ...
              ingredients = ["Dark Rum", "Lime Juice", "Sugar", "Blueberries", "Lemon-lime soda"]
              ingredients.each do |ingredient|
                RecipeIngredient.create(recipe: recipe, ingredient: Ingredient.find_by(name: ingredient.downcase))
              end

# Recipe 62
recipe = Recipe.create(name: "Zoksel",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 63
recipe = Recipe.create(name: "Acapulco",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 64
recipe = Recipe.create(name: "Bluebird",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 65
recipe = Recipe.create(name: "Midnight Manx",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 66
recipe = Recipe.create(name: "Applecar",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 67
recipe = Recipe.create(name: "Alice in Wonderland",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 68
recipe = Recipe.create(name: "Alexander",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 69
recipe = Recipe.create(name: "Slippery Nipple",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 70
recipe = Recipe.create(name: "Queen Charlotte",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 71
recipe = Recipe.create(name: "Golden Dream",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 72
recipe = Recipe.create(name: "Flaming Lamborghini",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 73
recipe = Recipe.create(name: "Aztec Punch",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 74
recipe = Recipe.create(name: "Jackhammer",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 75
recipe = Recipe.create(name: "Moranguito",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 76
recipe = Recipe.create(name: "Classic Old-Fashioned",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 77
recipe = Recipe.create(name: "Godchild",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 78
recipe = Recipe.create(name: "B-53",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 79
recipe = Recipe.create(name: "Darkwood Sling",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 80
recipe = Recipe.create(name: "Black Russian",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 82
recipe = Recipe.create(name: "Mississippi Planters Punch",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 83
recipe = Recipe.create(name: "Miami Vice",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 84
recipe = Recipe.create(name: "Citrus Coke",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 85
recipe = Recipe.create(name: "English Rose Cocktail",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 86
recipe = Recipe.create(name: "Jack Rose Cocktail",
              event_type: ["Home", "Business", "Special Ocasion"],
              instruction: "Shake all ingredients with ice, strain into a cocktail glass, and serve.",
              alcohol: "Alcoholic",
              cocktail_category: ["Fruity"],
...
# Recipe 87
recipe = Recipe.create(name: "Rum Punch",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 88
recipe = Recipe.create(name: "Apple Slammer",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 89
recipe = Recipe.create(name: "Apricot Punch",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 90
recipe = Recipe.create(name: "Dirty Nipple",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 91
recipe = Recipe.create(name: "Sidecar Cocktail",
              event_type: ["Home", "Business", "Special Ocasion"],
              instruction: "Shake all ingredients with ice, strain into a cocktail glass, and serve.",
              alcohol: "Alcoholic",
              cocktail_category: ["Salty"],
...
# Recipe 92
recipe = Recipe.create(name: "Chocolate Milk",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 93
recipe = Recipe.create(name: "Orange Whip",
              event_type: ["Home", "Special Ocasion"],
...
# Recipe 94
recipe = Recipe.create(name: "Almond Joy",
              event_type: ["Home", "Business", "Special Ocasion"],
              instruction: "Shake all ingredients with ice, strain into a cocktail glass, and serve.",
              alcohol: "Alcoholic",
              cocktail_category: ["Sour"],
...
# Recipe 95
recipe = Recipe.create(name: "Addison",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 96
recipe = Recipe.create(name: "Valencia Cocktail",
              event_type: ["Home", "Business", "Special Ocasion"],
              instruction: "Shake all ingredients with ice, strain into a cocktail glass, and serve.",
              alcohol: "Alcoholic",
              cocktail_category: ["Fruity"],
...
# Recipe 97
recipe = Recipe.create(name: "Halloween Punch",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 98
recipe = Recipe.create(name: "Artillery",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 99
recipe = Recipe.create(name: "Boulevardier",
              event_type: ["Home", "Business", "Special Ocasion"],
...
# Recipe 100
recipe = Recipe.create(name: "155 Belmont",
              event_type: ["Home", "Business", "Special Ocasion"],
